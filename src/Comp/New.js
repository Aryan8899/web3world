...
function New() {
    ...
    const fetchTrendingData = async () => {
      try {
        const response = await axios.get(
          "https://api1.webthreeworld.com/api/trending"
        );
    ...
    const fetchGainersAndLosers = async () => {
      try {
        const gainersResponse = await axios.get(
          "https://api1.webthreeworld.com/api/top-gainers"
        );
        const losersResponse = await axios.get(
          "https://api1.webthreeworld.com/api/top-losers"
        );
  ...
  const renderSlide = (slide) => {
    if (slide.title === "Trending") {
      return (
        <div className="box-container p-4 border border-gray-300 rounded-lg shadow-md bg-white h-49 flex flex-col justify-between ">
          <div>
            <div className="flex justify-between items-center mb-4 h-15 ">
              <h3 className="font-bold text-lg box-title ">🔥 {slide.title}</h3>
      ...
      // Render top gainers
      return (
        <div className=" p-4 border border-gray-300 rounded-lg shadow-md bg-white h-49 flex flex-col justify-between">
          <div>
            <h4 className="font-bold text-lg mb-3 mt-2 box-title">
              Top Gainers
            </h4>
                ...
                {gainers.map((crypto, index) => (
                  ...
                  >
                    ...
                    <span className="text-green-600 text-lg">
                      {(parseFloat(crypto.changePercent24Hr) % 100).toFixed(2)}%
                    </span>
                  </li>
                ))}
              </ul>
      ...
      return (
        <div className="h-full">
          <div className="text-center h-full ">
            ...
            >
              <img
                className="relative cursor-pointer border-gray-300 rounded-lg shadow-md bg-white w-full h-full object-cover"
                src={trade}
                alt="Advertisement"
              />
            </a>
      ...
      return (
        <div className="h-full">
          <div className="text-center h-full">
            ...
            >
              <img
                className="relative cursor-pointer border-gray-300 rounded-lg shadow-md bg-white w-full h-full flex flex-col justify-center mx-auto"
                src={kuku}
                alt="Advertisement"
              />
            </a>
  ...
  return (
    <>
      <Helmet>
        <title>
          Live Cryptocurrency Prices, Interactive Charts, and Market
          Capitalizations.
        </title>
        <meta
          name="description"
          content={`Join our team! We're looking for talented blockchain developers to drive
innovation in the crypto space`}
      ...
      <div className="App">
        ...
        {enabled && (
          <div className="h-20 container mx-auto px-4 py-8 flex flex-wrap ">
            <div className="h-full md:w-1/3 px-2 mb-4 w-full">
              <Slider {...settings}>
                {[
                  {
                    title: "Trending",
            ...
            <div className="h-full md:w-1/3 px-2 hidden md:block mb-4">
            ...
            <div className="w-full md:w-1/3 px-2 mb-4 h-full hidden md:block mt-1 ">
              <Slider {...settings}>
                {[
                  {
                    title: "Advertisement",
